...
export class BenefitsSectionComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  benefits = [
    {
      id: 1,
      title: 'BENEFITS.TECH_PARTNER.TITLE',
      description: 'BENEFITS.TECH_PARTNER.DESCRIPTION',
    },
    {
      id: 2,
      title: 'BENEFITS.EFFICIENCY.TITLE',
      description: 'BENEFITS.EFFICIENCY.DESCRIPTION',
    },
    {
      id: 3,
      title: 'BENEFITS.USER_EXPERIENCE.TITLE',
      description: 'BENEFITS.USER_EXPERIENCE.DESCRIPTION',
    },
    {
      id: 4,
      title: 'BENEFITS.FUTURE_PROOF.TITLE',
      description: 'BENEFITS.FUTURE_PROOF.DESCRIPTION',
    }
  ];
  ...
  private checkScrollPosition(): void {
    ...
    this.animationFrameId = requestAnimationFrame(() => {
      ...
      // Only lock if we're sufficiently within the section and hae never locked before
